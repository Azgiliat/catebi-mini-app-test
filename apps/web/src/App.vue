<template>
  ...
  >
    ...
    >
      ...
      <nav
        class="sticky bottom-0 z-20 grid h-[69px] grid-cols-3 border-t border-gray-200 bg-white"
      >
        <RouterLink
...
} from "@/modules/settings/route-names";
import { useUserStore } from "@/stores/user.store.ts";

import AppIcon from "./common/components/AppIcon.vue";
import GlobalLoader from "./common/components/GlobalLoader.vue";
import {
...
const loaderDelay = ref(false);

type RouteName = AdoptionRouteName | FavouritesRouteName | SettingsRouteName;
...
const navigation: NavigationItem[] = [
  ...
  {
    routeName: SETTINGS_ROUTE_NAMES.SETTINGS,
    to: { name: SETTINGS_ROUTE_NAMES.SETTINGS },
