const TELEGRAM_DEV_BOT_TOKEN = import.meta.env.VITE_TELEGRAM_DEV_BOT_TOKEN;
...
const createTelegramHash = async (params: URLSearchParams) => {
  if (!TELEGRAM_DEV_BOT_TOKEN) {
    throw new Error("VITE_TELEGRAM_DEV_BOT_TOKEN is not set");
  }
